...
for optimizer_name in optimizer_names:
    for learning_rate in learning_rates:
        ...
        for epoch in range(EPOCHS):
            ...
            writer.add_scalar(
                tag="Training Loss", scalar_value=train_loss, global_step=epoch
            )
            writer.add_scalar(
                tag="Training Accuracy", scalar_value=accuracy, global_step=epoch
            )
        ...
        test_loss, test_acc = test_step(
            model=model, criterion=criterion, testloader=testloader, epoch=0
        )
